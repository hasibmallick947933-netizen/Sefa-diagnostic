  ...
  return (
    <main className="pt-28 pb-16 min-h-screen bg-neutral-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        {/* Filters */}
        <div className="bg-white rounded-2xl shadow-card p-5 mb-8 flex flex-col sm:flex-row gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {filtered.map(doc => (
            <article key={doc.id} className="card p-6 group hover:-translate-y-1 transition-all duration-300">
              {/* Header */}
